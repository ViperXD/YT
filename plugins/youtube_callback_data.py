    ...
    if cb_data.startswith("ytdata||"):
        ...
        if media_type == 'audio':
            buttons = InlineKeyboardMarkup([[InlineKeyboardButton(
                "As Audio", callback_data=f"{media_type}||{format_id}||{yturl}"), InlineKeyboardButton("As Document",
                                                                                                    callback_data=f"docaudio||{format_id}||{yturl}")]])
        else:
            buttons = InlineKeyboardMarkup([[InlineKeyboardButton(
                "As Video", callback_data=f"{media_type}||{format_id}||{yturl}"), InlineKeyboardButton("As Document",
